...
import DevProUnitsCatBar from '../DevProUnitsCatBar';
...
const DevProUnitsPage: React.FC<DevelopersProjectsLayoutProps> = ({ params, onClose }) => {
...
export default DevProUnitsPage;