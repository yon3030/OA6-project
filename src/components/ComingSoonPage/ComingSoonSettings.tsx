...
const ComingSoonSupport = () => {
  ...
  return (
    <>
      <div className="max-w-[calc(100vw-1rem)] md:max-w-screen md:w-full h-[calc(100vh-12rem)] md:h-[85vh] relative gradient-border gradient-default-border gradient-border-rounded-30px bg-coming-soon-settings-back bg-no-repeat bg-cover text-white">
