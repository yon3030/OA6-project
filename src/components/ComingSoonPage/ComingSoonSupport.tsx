const quote: string =
  "If you are require expert consultation, our artificial intelligence is available here to address all your queries.";

const ComingSoonSupport = () => {
   // const marginValue = window.innerHeight - 950;
  return (
    <>
      <div className="max-w-[calc(100vw-1rem)] md:max-w-screen md:w-full h-[calc(100vh-12rem)] md:h-[85vh] relative gradient-border gradient-default-border gradient-border-rounded-30px bg-coming-soon-support-back bg-no-repeat bg-cover text-white">
